...
keys.globalkeys = gears.table.join(
    awful.key({ modkey,           }, "w",  function() 
      awful.spawn.with_shell("brave")    end,
              {description="brave", group="awesome"}),
    awful.key({ modkey,           }, "Return",  function() 
      awful.spawn.with_shell("alacritty")    end,
              {description="terminal", group="awesome"}),

    awful.key({ modkey,           }, "e",  function() 
      awful.spawn.with_shell("alacritty -e lf")    end,
              {description="file manager", group="awesome"}),

    awful.key({ modkey,           }, "t",  function() 
      awful.spawn.with_shell("alacritty -e lvim ~/Documents/notes/todo")    end,
              {description="todo", group="awesome"}),
   ...
   awful.key({ modkey,           }, "l",     function () 
    ...
    awful.key({ altkey }, "space", function () awful.spawn.with_shell("rofi -show drun") end),
    awful.key({  }, "Print",     function () awful.spawn.with_shell("screenshot") end),

    awful.key({ "Control","Shift" }, "Print",     function () awful.spawn.with_shell("python3 /home/ajrv/Projects/PycharmProjects/LinuxIMGtoCLIP/main.py") end),

    awful.key({ "Shift" }, "Print",     function () 
        awful.spawn.with_shell("screenshot -s")  end),
     
    -- media controls
    awful.key({}, "F3", function ()
        awful.spawn.easy_async_with_shell("amixer -D pulse sset Master 5%-", function(stdout)

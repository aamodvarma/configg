...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ superkey }, "z", awful.tag.viewprev),

    awful.key({ superkey }, "x", awful.tag.viewnext),
    ...
    awful.key({ superkey }, "Up",
        ...
        {description = "focus up", group = "client"}),
    awful.key({ superkey }, "eft",
        function()
            awful.client.focus.bydirection("left")
        end,
        {description = "focus left", group = "client"}),
    awful.key({ superkey }, "ight",
        function()
            awful.client.focus.bydirection("right")
        end,
        {description = "focus right", group = "client"}),
...
--
    -- Spawn terminal
    awful.key({ superkey, shiftkey }, "Return", function () awful.spawn(user.terminal) end,
...
>>>>>>> ea4b3a0 (change)
    ...
    -- Reload Awesome
    awful.key({ superkey,control, shiftkey }, "r", awesome.restart,
...
>>>>>>> ea4b3a0 (change)
    ...
    -- Editor
    awful.key({ superkey }, "es", apps.editor,
